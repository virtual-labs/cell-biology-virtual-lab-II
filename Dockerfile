...
# Usage: Installing dependencies for cell-biology-virtual-lab-II
RUN apt-get install -y make rsync apache2 wget php5

RUN mkdir /cell-biology-virtual-lab-II

COPY src/ /cell-biology-virtual-lab-II/src

WORKDIR ./cell-biology-virtual-lab-II/src
